...
%Plant Inputs
inputs.Plant.Aerodynamics.cycleAverage = 1;
%Controller Inputs
...
inputs.Commands.xCommand.data = [0;1;-3;0];
inputs.Commands.xCommand.time = [0;20;40;80];

inputs.Commands.yCommand = timeseries;
inputs.Commands.yCommand.data = [0;1;-3;0];
inputs.Commands.yCommand.time = [0;5;25;80];

inputs.Commands.zCommand = timeseries;
inputs.Commands.zCommand.data = [0;1;5;0];
inputs.Commands.zCommand.time = [0;5;40;100];

inputs.Commands.psiCommand = timeseries;
inputs.Commands.psiCommand.data = [0;45;0;0];
inputs.Commands.psiCommand.time = [0;5;40;100];

inputs.Commands.thetaCommand = timeseries;
inputs.Commands.thetaCommand.data = [0;0;0;0];
inputs.Commands.thetaCommand.time = [0;1;20;100];
...
%Command Enables
inputs.Commands.xCommandEnable = 1;
